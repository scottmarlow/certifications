...
Product Name, Version: WildFly 34.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_34.0.1.Final/jakarta-full-platform-jdk17.adoc#tck-results[WildFly 34.0.1.Final TCK results]
